...
var youtuber$ = new rxjs_1.Subject();
youtuber$.next(1);
var observerA = {
  next: function next(id) {
    console.log("\u6211\u662F\u89C0\u5BDF\u8005A\uFF0C\u6211\u6536\u5230\u5F71\u7247".concat(id, "\u4E0A\u67B6\u901A\u77E5\u4E86"));
  },
  error: function error() {},
  complete: function complete() {}
};
var observerASubscription = youtuber$.subscribe(observerA);
youtuber$.next(2);
var observerBSubscription = youtuber$.subscribe(function (id) {
  console.log("\u6211\u662F\u89C0\u5BDF\u8005B\uFF0C\u6211\u6536\u5230\u5F71\u7247".concat(id, "\u4E0A\u67B6\u901A\u77E5\u4E86"));
});
youtuber$.next(3);
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ObserverPractice_rxjs.ts"], null)
//# sourceMappingURL=/ObserverPractice_rxjs.8bc3bed5.js.map